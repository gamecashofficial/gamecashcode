...
uint256 hashGenesisBlock("0x8cc946edc2599addda4c736ac1c497c4bcaa63dc3468e8f42b7b51b36d811b02");
...
static const int64 nTargetTimespan = 2 * 24 * 60 * 60; // Gamecash: 2 days
static const int64 nTargetSpacing = 1 * 30; // Gamecash: 30 seconds
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x8cc946edc2599addda4c736ac1c497c4bcaa63dc3468e8f42b7b51b36d811b02");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Friday 22 September 2017 GMT:22:23";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1506115365;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2278399;
        ...
        assert(block.hashMerkleRoot == uint256("0x8ea39911b2a8d79d3e5302a56689b3a6829ccb93d58ba7a74e9e6c25150791a9"));
